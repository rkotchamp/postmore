...
const VideoClipSchema = new mongoose.Schema({
  ...
  // Template header generated by DeepSeek for social media overlays
  templateHeader: {
    type: String,
    trim: true,
    // Generated by DeepSeek AI analysis - short punchy hook
  },

  // Custom template data for user personalization
  templateCustomData: {
    username: String, // User input for social templates
    profileIcon: String, // Firebase URL for uploaded profile pic
    customTitle: String, // Override for template header if user wants custom
  },
  ...
  // Preview video for template cards (1-minute extract)
  previewVideo: {
    path: String,
    url: String,
    duration: {
