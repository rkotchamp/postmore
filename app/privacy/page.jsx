"use client"; // Needed if we use hooks, but good practice for pages with components

import ReactMarkdown from "react-markdown";
import remarkGfm from "remark-gfm";

// Paste the raw markdown content here
// For server components, you could read this using fs
const markdownContent = `
# Privacy Policy for PostMore Social Scheduler
